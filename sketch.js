...
var pathImg,boy_deadImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg;
...
function preload(){
  ...
  boy_deadImg=loadImage("dead man-02 (1).png")
...
boy.addAnimation("dead",boy_deadImg);
boy.scale=0.08;
...
function draw() {
  ...
  if (gameState===END){
    ...
    boy.velocityY=0;
    boy.changeAnimation("dead", boy_deadImg);
    path.velocityY=0;
